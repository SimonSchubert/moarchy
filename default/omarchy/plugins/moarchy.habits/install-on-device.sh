#!/bin/bash
# Copy Habits onto the phone, with qs_ui vendored as ui/.
#
#   plugins/moarchy.habits/install-on-device.sh
#
...
ENDSSH
echo "==> done. tap Habits in the appDrawer, or: omarchy-shell shell toggle $ID"
