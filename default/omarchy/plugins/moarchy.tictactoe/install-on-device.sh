#!/bin/bash
# Copy Tictactoe onto the phone, with qs_ui vendored as ui/.
#
#   plugins/moarchy.tictactoe/install-on-device.sh
#
...
ENDSSH
echo "==> done. tap Tictactoe in the appDrawer, or: omarchy-shell shell toggle $ID"
