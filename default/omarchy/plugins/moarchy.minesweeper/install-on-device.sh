#!/bin/bash
# Copy Minesweeper onto the phone, with qs_ui vendored as ui/.
#
#   plugins/moarchy.minesweeper/install-on-device.sh
#
...
ENDSSH
echo "==> done. tap Minesweeper in the appDrawer, or: omarchy-shell shell toggle $ID"
