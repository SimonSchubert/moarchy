#!/bin/bash
# Copy Reversi onto the phone, with qs_ui vendored as ui/.
#
#   plugins/moarchy.reversi/install-on-device.sh
#
...
ENDSSH
echo "==> done. tap Reversi in the appDrawer, or: omarchy-shell shell toggle $ID"
