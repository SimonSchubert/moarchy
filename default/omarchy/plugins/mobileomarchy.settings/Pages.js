...
"appearance.bar": { title: "Status bar", rows: [
  ...
  { id: "battery", type: "switch", glyph: "󰁹", label: "Battery percentage",
    read: "omarchy-toggle-enabled battery-percentage && echo true || echo false",
    on: "omarchy-toggle battery-percentage on && omarchy-shell -q omarchy.bar syncHidden",
    off: "omarchy-toggle battery-percentage off && omarchy-shell -q omarchy.bar syncHidden",
