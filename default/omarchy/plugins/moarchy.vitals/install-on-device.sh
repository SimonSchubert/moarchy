#!/bin/bash
# Copy Vitals onto the phone, with qs_ui vendored as ui/.
#
#   plugins/moarchy.vitals/install-on-device.sh
#
...
ENDSSH
echo "==> done. tap Vitals in the appDrawer, or: omarchy-shell shell toggle $ID"
