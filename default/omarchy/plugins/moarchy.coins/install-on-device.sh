#!/bin/bash
# Copy Coins onto the phone, with qs_ui vendored as ui/.
#
#   plugins/moarchy.coins/install-on-device.sh
#
...
ENDSSH
echo "==> done. tap Coins in the appDrawer, or: omarchy-shell shell toggle $ID"
