#!/bin/bash
# Copy Phone onto the phone, with qs_ui vendored as ui/.
#
#   plugins/moarchy.phone/install-on-device.sh
#
...
ENDSSH
echo "==> done. tap Phone in the appDrawer, or: omarchy-shell shell toggle $ID"
