#!/bin/bash
# Copy Calculator onto the phone, with qs_ui vendored as ui/.
#
...
ENDSSH
echo "==> done. tap Calculator in the appDrawer, or: omarchy-shell shell toggle $ID"
