#!/bin/bash
# Copy Files onto the phone, with qs_ui vendored as ui/.
#
#   plugins/moarchy.files/install-on-device.sh
#
...
ENDSSH
echo "==> done. tap Files in the appDrawer, or: omarchy-shell shell toggle $ID"
