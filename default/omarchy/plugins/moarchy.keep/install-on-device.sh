#!/bin/bash
# Copy Keep onto the phone, with qs_ui vendored as ui/.
#
#   plugins/moarchy.keep/install-on-device.sh
#
...
ENDSSH
echo "==> done. tap Keep in the appDrawer, or: omarchy-shell shell toggle $ID"
