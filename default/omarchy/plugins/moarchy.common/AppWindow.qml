...
// workspace overview (K1) rather than one this file has to draw.
...
// drop in the workspace overview's bin sends (P13) -- and Quickshell answers that by
// setting
...
FloatingWindow {
  ...
  // What a tile in the workspace overview calls this screen, and the first half of the
  // title.
  ...
  // Everything the workspace overview and the back gesture ask of a shell app goes
  ...
  // a drop in the workspace overview's bin sends and what `swaymsg kill` and a paired
